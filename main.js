/*document.addEventListener('DOMContentLoaded', () => {
    ...
    const cartItemsList = document.querySelector('.cart-item'); // Corrected selector
    const cartTotal = document.querySelector('.cart-total');
    const cartIcon = document.querySelector('.cart-icon'); // Corrected selector
    const sidebar = document.getElementById('sidebar');
    const cardTitles = document.querySelectorAll('.card--title'); // Corrected selector
    ...
    addToCartButtons.forEach((button, index) => {
        button.addEventListener('click', () => {
            const item = {
                name: cardTitles[index].textContent.trim(), // Trimmed whitespace
